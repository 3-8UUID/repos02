    ...
    <DIV class=dialog>
        ...
        <DIV class=box>
            <FORM id=add_action method=post name=add.action enctype="multipart/form-data"
                  action="../houseController/add">
                <DIV class=infos>
                    <TABLE class=field>
                        <TBODY>
                        <TR>
                            <TD class=field>标　　题：</TD>
                            <TD><INPUT id=add_action_title class=text type=text name=title required></TD>
                        </TR>
                        <TR>
                        ...
                        <TR>
                            ...
                            <TD><INPUT id=add_action_floorage class=text type=text name=floorage
                        ...
                        <TR>
                            ...
                            <TD><INPUT class=text type=date name=pubdate required></TD>
                        </TR>
                        <TR>
