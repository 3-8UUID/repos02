...
dojo.html.toCoordinateObject = dojo.html.toCoordinateArray = function (_534, _535, _536) {
    if (_534 instanceof Array || typeof _534 == "array") {
        ...
        if (!_534.nodeType && !(_534 instanceof String || typeof _534 == "string") && ("width" in _534 || "height" in _534 || "left" in _534 || "x" in _534 || "top" in _534 || "y" in _534)) {
            var ret = {
                left: _534.left || _534.x || 0,
                top: _534.top || _534.y || 0,
                width: _534.width || 0,
                height: _534.height || 0
            };
        } else {
...
dojo.lfx.html.slideTo = function (_5aa, _5ab, _5ac, _5ad, _5ae) {
    ...
    dojo.lang.forEach(_5aa, function (node) {
        ...
        init();
        var anim = dojo.lfx.propertyAnimation(node, {
            "top": {start: top, end: (_5ab.top || 0)},
            "left": {start: left, end: (_5ab.left || 0)}
...
dojo.lfx.html.slideBy = function (_5b9, _5ba, _5bb, _5bc, _5bd) {
    ...
    dojo.lang.forEach(_5b9, function (node) {
        ...
        init();
        var anim = dojo.lfx.propertyAnimation(node, {
            "top": {start: top, end: top + (_5ba.top || 0)},
            "left": {start: left, end: left + (_5ba.left || 0)}
...
dojo.ns = {
    namespaces: {}, failed: {}, loading: {}, loaded: {}, register: function (name, _635, _636, _637) {
...
dojo.widget.Parse = function (_6ef) {
    ...
    this.getDataProvider = function (_706, _707) {
        dojo.io.bind({
            url: _707, load: function (type, _709) {
                if (type == "load") {
...
dojo.widget.wai = {
    waiRole: {name: "waiRole", "namespace": "http://www.w3.org/TR/xhtml2", alias: "x2", prefix: "wairole:"},
    waiState: {name: "waiState", "namespace": "http://www.w3.org/2005/07/aaa", alias: "aaa", prefix: ""},
    setAttr: function (node, ns, attr, _741) {
        if (dojo.render.html.ie) {
...
dojo.declare("dojo.widget.DomWidget", dojo.widget.Widget, function () {
    ...
    addChild: function (_770, _771, pos, ref, _774) {
        if (!this.isContainer) {
...
dojo.lfx.toggle.plain = {
    show: function (node, _801, _802, _803) {
        dojo.html.show(node);
...
dojo.lfx.toggle.fade = {
    show: function (node, _809, _80a, _80b) {
...
dojo.lfx.toggle.wipe = {
    show: function (node, _811, _812, _813) {
...
dojo.lfx.toggle.explode = {
    show: function (node, _819, _81a, _81b, _81c) {
...
dojo.kwCompoundRequire({
    common: ["dojo.xml.Parse", "dojo.widget.Widget", "dojo.widget.Parse", "dojo.widget.Manager"],
    browser: ["dojo.widget.DomWidget", "dojo.widget.HtmlWidget"],
    dashboard: ["dojo.widget.DomWidget", "dojo.widget.HtmlWidget"],
...
dojo.widget.defineWidget("dojo.widget.RichText", dojo.widget.HtmlWidget, function () {
    ...
    queryCommandAvailable: function (_8ec) {
        ...
        function isSupportedBy(_8f3) {
            return {
                ie: Boolean(_8f3 & ie),
                mozilla: Boolean(_8f3 & _8ee),
                safari: Boolean(_8f3 & _8ef),
                safari420: Boolean(_8f3 & _8f1),
                opera: Boolean(_8f3 & _8f0)
            };
        }
...
dojo.lang.extend(dojo.AdapterRegistry, {
    register: function (name, _94a, wrap, _94c, _94d) {
...
dojo.lang.extend(dojo.html.BackgroundIframe, {
    iframe: null, onResized: function () {
...
dojo.widget.defineWidget("dojo.widget.ColorPalette", dojo.widget.HtmlWidget, {
    palette: "7x10",
    _palettes: {
        "7x10": [["fff", "fcc", "fc9", "ff9", "ffc", "9f9", "9ff", "cff", "ccf", "fcf"], ["ccc", "f66", "f96", "ff6", "ff3", "6f9", "3ff", "6ff", "99f", "f9f"], ["c0c0c0", "f00", "f90", "fc6", "ff0", "3f3", "6cc", "3cf", "66c", "c6c"], ["999", "c00", "f60", "fc3", "fc0", "3c0", "0cc", "36f", "63f", "c3c"], ["666", "900", "c60", "c93", "990", "090", "399", "33f", "60c", "939"], ["333", "600", "930", "963", "660", "060", "366", "009", "339", "636"], ["000", "300", "630", "633", "330", "030", "033", "006", "309", "303"]],
        "3x4": [["ffffff", "00ff00", "008000", "0000ff"], ["c0c0c0", "ffff00", "ff00ff", "000080"], ["808080", "ff0000", "800080", "000000"]]
    },
...
dojo.widget.defineWidget("dojo.widget.ContentPane", dojo.widget.HtmlWidget, function () {
    ...
    isLoaded: false,
    postCreate: function (args, frag, _99b) {
        if (this.handler !== "") {
    ...
    _downloadExternalContent: function (url, _99f) {
        ...
        var self = this;
        this._ioBindObj = dojo.io.bind(this._cacheSetting({
            url: url, mimetype: "text/html", handler: function (type, data, xhr) {
        ...
        for (var i = 0; i < _9e6.length; i++) {
            if (_9e6[i].path) {
                dojo.io.bind(this._cacheSetting({
                    "url": _9e6[i].path, "load": function (type, _9ec) {
...
dojo.declare("dojo.widget.Editor2ToolbarComboItem", dojo.widget.Editor2ToolbarDropDownButton, {
    href: null, create: function (node, _a18) {
...
dojo.declare("dojo.widget.Editor2ToolbarFormatBlockSelect", dojo.widget.Editor2ToolbarComboItem, {
    href: dojo.uri.moduleUri("dojo.widget", "templates/Editor2/EditorToolbar_FormatBlock.html"), setup: function () {
...
dojo.declare("dojo.widget.Editor2ToolbarFontSizeSelect", dojo.widget.Editor2ToolbarComboItem, {
    href: dojo.uri.moduleUri("dojo.widget", "templates/Editor2/EditorToolbar_FontSize.html"), setup: function () {
        dojo.widget.Editor2ToolbarFormatBlockSelect.superclass.setup.call(this);
...
dojo.widget.html.layout = function (_a57, _a58, _a59) {
    ...
    var f = {
        top: dojo.html.getPixelValue(_a57, "padding-top", true),
        left: dojo.html.getPixelValue(_a57, "padding-left", true)
    };
...
dojo.declare("dojo.dnd.DragManager", null, {
    selectedSources: [], dragObjects: [], dragSources: [], registerDragSource: function (_a77) {
...
dojo.declare("dojo.dnd.HtmlDragObject", dojo.dnd.DragObject, {
    dragClass: "", opacity: 0.5, createIframe: true, disableX: false, disableY: false, createDragNode: function () {
        ...
        this.containingBlockPosition = this.domNode.offsetParent ? dojo.html.getAbsolutePosition(this.domNode.offsetParent, true) : {
            x: 0,
            y: 0
        };
        if (this.constrainToContainer) {
    ...
    vertical: false, onDragOver: function (e) {
        ...
        for (var i = 0, _adf; i < this.domNode.childNodes.length; i++) {
            ...
            this.childBoxes.push({
                top: pos.y,
                bottom: pos.y + _ae1.height,
                left: pos.x,
                right: pos.x + _ae1.width,
                height: _ae1.height,
                width: _ae1.width,
                node: _adf
            });
...
dojo.widget.defineWidget("dojo.widget.Dialog", [dojo.widget.ContentPane, dojo.widget.ModalDialogBase], {
...
dojo.declare("dojo.widget.FloatingPaneBase", null, {
    ...
    resizeTo: function (_b3e, _b3f) {
        ...
        dojo.widget.html.layout(this.domNode, [{domNode: this.titleBar, layoutAlign: "top"}, {
            domNode: this.resizeBar,
            layoutAlign: "bottom"
...
dojo.widget.defineWidget("dojo.widget.FloatingPane", [dojo.widget.ContentPane, dojo.widget.FloatingPaneBase], {
...
dojo.widget.defineWidget("dojo.widget.ModalFloatingPane", [dojo.widget.FloatingPane, dojo.widget.ModalDialogBase], {
    windowState: "minimized", displayCloseAction: true, postCreate: function () {
...
dojo.lang.mixin(dojo.widget.Editor2Manager, {
    _currentInstance: null, commandState: {Disabled: 0, Latched: 1, Enabled: 2}, getCurrentInstance: function () {
        ...
        switch (name) {
            ...
            case "anchor":
                ...
                break;
            case "createlink":
                _b51 = new dojo.widget.Editor2DialogCommand(_b4f, name, {
...
dojo.widget.defineWidget("dojo.widget.Editor2Dialog", [dojo.widget.HtmlWidget, dojo.widget.FloatingPaneBase, dojo.widget.ModalDialogBase], {
...
dojo.widget.defineWidget("dojo.widget.Editor2DialogContent", dojo.widget.HtmlWidget, {
    widgetsInTemplate: true, loadContent: function () {
        return true;
    }, cancel: function () {
        this.parent.hide();
    }
...
dojo.widget.defineWidget("dojo.widget.Editor2", dojo.widget.RichText, function () {
    ...
    onDisplayChanged: function (e, _b71) {
...
dojo.widget.defineWidget("struts.widget.Bind", dojo.widget.HtmlWidget, {
    widgetType: "Bind",
    executeScripts: false,
    ...
    _executeScripts: function (_bad) {
        ...
        for (var i = 0; i < _bad.length; i++) {
            if (_bad[i].path) {
                dojo.io.bind(this._cacheSetting({
                    "url": _bad[i].path, "load": function (type, _bb3) {
...
dojo.widget.defineWidget("struts.widget.BindDiv", dojo.widget.ContentPane, {
    widgetType: "BindDiv",
    href: "",
...
dojo.widget.defineWidget("struts.widget.BindAnchor", struts.widget.Bind, {
    widgetType: "BindAnchor", events: "onclick", postCreate: function () {
...
dojo.declare("dojo.widget.incrementalComboBoxDataProvider", null, function (_c0d) {
    ...
    _addToCache: function (_c0e, data) {
        ...
        var _c14 = this;
        var _c15 = this._lastRequest = dojo.io.bind({
            url: _c13, method: "get", mimetype: "text/json", load: function (type, data, evt) {
...
dojo.widget.defineWidget("struts.widget.ComboBox", dojo.widget.ComboBox, {
    widgetType: "ComboBox",
    dropdownHeight: 120,
    dropdownWidth: 0,
    itemHeight: 0,
...
dojo.widget.defineWidget("dojo.widget.TimePicker", dojo.widget.HtmlWidget, function () {
    ...
    postMixInProperties: function (_dba, frag) {
...
dojo.widget.defineWidget("dojo.widget.DropdownTimePicker", dojo.widget.DropdownContainer, {
        ...
        if (this.timePicker.selectedTime.anyTime) {
            ...
            if (this.timeFormat) {
                ...
                this.inputNode.value = dojo.date.format(this.timePicker.time, {
                    ...
                    timePattern: this.displayFormat,
                    selector: "timeOnly",
                    locale: this.lang
                });
            }
...
dojo.widget.defineWidget("struts.widget.StrutsTimePicker", dojo.widget.DropdownTimePicker, {
...
dojo.widget.defineWidget("dojo.widget.DropdownDatePicker", dojo.widget.DropdownContainer, {
    ...
    weekStartsOn: "",
    staticDisplay: false,
    postMixInProperties: function (_e55, frag) {
    ...
    _updateText: function () {
        this.inputNode.value = this.datePicker.value ? dojo.date.format(this.datePicker.value, {
            formatLength: this.formatLength,
...
dojo.widget.defineWidget("struts.widget.StrutsDatePicker", dojo.widget.DropdownDatePicker, {
...
dojo.widget.defineWidget("struts.widget.BindEvent", struts.widget.Bind, {
    widgetType: "BindEvent", sources: "", postCreate: function () {
...
dojo.widget.defineWidget("dojo.widget.TreeSelector", dojo.widget.HtmlWidget, function () {
    ...
    selectedNode: null,
    dieWithTree: false,
    eventNamesDefault: {select: "select", destroy: "destroy", deselect: "deselect", dblselect: "dblselect"},
    initialize: function () {
...
dojo.widget.defineWidget("struts.widget.StrutsTreeSelector", dojo.widget.TreeSelector, {
...
dojo.widget.defineWidget("dojo.widget.PageController", dojo.widget.HtmlWidget, {
...
dojo.widget.defineWidget("dojo.widget.PageButton", dojo.widget.HtmlWidget, {
    templateString: "<span class='item'>" + "<span dojoAttachEvent='onClick' dojoAttachPoint='titleNode' class='selectButton'>${this.label}</span>" + "<span dojoAttachEvent='onClick:onCloseButtonClick' class='closeButton'>[X]</span>" + "</span>",
    label: "foo",
    closeButton: false,
    onClick: function () {
        this.focus();
...
dojo.lang.extend(dojo.widget.Widget, {
    label: "", selected: false, closable: false, onClose: function () {
        return true;
    }
});
...
dojo.widget.defineWidget("dojo.widget.TabContainer", dojo.widget.PageContainer, {
    ...
    onResized: function () {
        ...
        var _eb4 = [{domNode: this.tablist.domNode, layoutAlign: _eb3}, {
...
dojo.widget.defineWidget("dojo.widget.TabController", dojo.widget.PageController, {
...
dojo.widget.defineWidget("dojo.widget.TabButton", dojo.widget.PageButton, {
    templateString: "<div class='dojoTab' dojoAttachEvent='onClick'>" + "<div dojoAttachPoint='innerDiv'>" + "<span dojoAttachPoint='titleNode' tabIndex='-1' waiRole='tab'>${this.label}</span>" + "<span dojoAttachPoint='closeButtonNode' class='close closeImage' style='${this.closeButtonStyle}'" + "    dojoAttachEvent='onMouseOver:onCloseButtonMouseOver; onMouseOut:onCloseButtonMouseOut; onClick:onCloseButtonClick'></span>" + "</div>" + "</div>",
    postMixInProperties: function () {
...
dojo.widget.defineWidget("dojo.widget.a11y.TabButton", dojo.widget.TabButton, {
    imgPath: dojo.uri.moduleUri("dojo.widget", "templates/images/tab_close.gif"),
    templateString: "<div class='dojoTab' dojoAttachEvent='onClick;onKey'>" + "<div dojoAttachPoint='innerDiv'>" + "<span dojoAttachPoint='titleNode' tabIndex='-1' waiRole='tab'>${this.label}</span>" + "<img class='close' src='${this.imgPath}' alt='[x]' style='${this.closeButtonStyle}'" + "    dojoAttachEvent='onClick:onCloseButtonClick'>" + "</div>" + "</div>"
});
dojo.provide("struts.widget.StrutsTabContainer");
dojo.widget.defineWidget("struts.widget.StrutsTabContainer", dojo.widget.TabContainer, {
...
dojo.widget.defineWidget("struts.widget.StrutsTreeNode", dojo.widget.TreeNode, {
    widgetType: "StrutsTreeNode", loaded: false, expand: function () {
        if (!this.loaded) {
            this.reload();
        }
        ...
        if (!dojo.string.isBlank(href)) {
            ...
            this.markLoading();
            dojo.io.bind({
                url: _ee8, useCache: false, preventCache: true, handler: function (type, data, e) {
                    if (type == "load") {
                        if (data) {
                            dojo.lang.forEach(data, function (_eed) {
                                var _eee = dojo.widget.createWidget("struts:StrutsTreeNode", {
                                    title: _eed.label,
                                    isFolder: _eed.hasChildren,
                                    widgetId: _eed.id
                                });
                                self.addChild(_eee);
                            });
...
dojo.json = {
    jsonRegistry: new dojo.AdapterRegistry(), register: function (name, _ef0, wrap, _ef2) {
...
dojo.widget.defineWidget("dojo.widget.TreeBasicController", dojo.widget.HtmlWidget, {
    widgetType: "TreeBasicController", DNDController: "", dieWithTree: false, initialize: function (args, frag) {
...
dojo.widget.defineWidget("dojo.widget.Tree", dojo.widget.HtmlWidget, function () {
    ...
    gridIconSrcT: dojo.uri.moduleUri("dojo.widget", "templates/images/Tree/treenode_grid_t.gif"),
    gridIconSrcL: dojo.uri.moduleUri("dojo.widget", "templates/images/Tree/treenode_grid_l.gif"),
    gridIconSrcV: dojo.uri.moduleUri("dojo.widget", "templates/images/Tree/treenode_grid_v.gif"),
    gridIconSrcP: dojo.uri.moduleUri("dojo.widget", "templates/images/Tree/treenode_grid_p.gif"),
    gridIconSrcC: dojo.uri.moduleUri("dojo.widget", "templates/images/Tree/treenode_grid_c.gif"),
    gridIconSrcX: dojo.uri.moduleUri("dojo.widget", "templates/images/Tree/treenode_grid_x.gif"),
    gridIconSrcY: dojo.uri.moduleUri("dojo.widget", "templates/images/Tree/treenode_grid_y.gif"),
    gridIconSrcZ: dojo.uri.moduleUri("dojo.widget", "templates/images/Tree/treenode_grid_z.gif"),
    ...
    showGrid: true,
    showRootGrid: true,
    actionIsDisabled: function (_f7d) {
        var _f7e = this;
...
dojo.widget.defineWidget("struts.widget.StrutsTree", dojo.widget.Tree, {
    widgetType: "StrutsTree", href: "", errorNotifyTopics: "", errorNotifyTopicsArray: null, postCreate: function () {
        ...
        if (!dojo.string.isBlank(this.href)) {
            dojo.io.bind({
                url: this.href, useCache: false, preventCache: true, handler: function (type, data, e) {
                    if (type == "load") {
                        if (data) {
                            dojo.lang.forEach(data, function (_fa8) {
                                var _fa9 = dojo.widget.createWidget("struts:StrutsTreeNode", {
                                    title: _fa8.label,
                                    isFolder: _fa8.hasChildren,
                                    widgetId: _fa8.id
                                });
                                self.addChild(_fa9);
                            });
